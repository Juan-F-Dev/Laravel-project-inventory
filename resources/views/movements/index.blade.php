        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            ...
            <tr class="*:font-bold">
                ...
                <th scope="col" class="px-6 py-3">sale point</th>
                ...
                <tr class="text-gray-800 border border-gray-200">
                    <td scope="row" class="px-6 py-4 font-medium whitespace-nowrap text-gray-900 ">
                        ...
                        <th class="flex justify-center items-center gap-1 py-2">
                            ...
                            <svg class="h-[20px] w-[20px] text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <form action="{{ route('movements.destroy', $movement) }}" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')

...
@section("content")
    ...
    <div class="">
        <a href="{{ route("products.create") }}"
            class="my-5 inline-block rounded border px-4 py-1 font-black transition-all duration-300 hover:scale-110 hover:bg-white hover:text-sky-950">
            Create Product
        </a>
                        ...
                        <tr
                            ...
                            <th class="flex justify-center items-center gap-1 py-2">
                                <a href="{{ route('products.edit', $product) }}"
                                    ...
                                    <svg class="h-[20px] w-[20px] text-gray-800 dark:text-white" aria-hidden="true"
